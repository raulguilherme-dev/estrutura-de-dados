public class ListaEncadeada {
    ...
    public void adicionaNoInicio(ListaEncadeada lista) {
        No novo = new No(lista, this.inicio);
        this.inicio = novo;
        if(this.totalDeElementos==0) {
            this.fim = novo;
        }
    ...
    public void adicionaNoFinal(ListaEncadeada lista) {
        if(this.totalDeElementos==0) {
            this.adicionaNoInicio(lista);
        }else {
...
/*public void ordenaLista(ListaEncadeada l) {
    ...
    //Questão 3
    public void trocaValores(String x, String y) {
        No atual = this.getInicio();
        No anteriorx = null;
        No posx = null;
        No anteriory = null;
